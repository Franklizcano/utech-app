...
export function CorporateUserManagement() {
  ...
  useEffect(() => { fetchCompaniesAction().then(setCompanies).catch(() => setError("No se pudieron cargar las empresas.")) }, [])
  ...
  async function save(e: React.FormEvent) {
    ...
    const result = await addUser({ name, email, phone, password, role: "cliente", companyId })
    setSaving(false)
